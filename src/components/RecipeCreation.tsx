...
export const RecipeCreation: React.FC<RecipeCreationProps> = ({ onRecipeCreate }) => {
  const { formData, handleInputChange, resetForm } = useRecipeForm();
  const [error, setError] = useState<string>('');

  const categories: Recipe['category'][] = ['Breakfast', 'Lunch', 'Dinner', 'Dessert', 'Snack', 'Beverage'];
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <p className="text-gray-600 mb-8">Add a new recipe to your collection</p>
